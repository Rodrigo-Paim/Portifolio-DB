    ...
    <Layout>
      <HeaderStyled style={{ display: "flex", alignItems: "center" }}>
        ...
        >
          ...
          <Item key="/curriculo">
            <Link
              to="https://drive.google.com/file/d/1LFMC1mrIKFK0FLxkVi1B2e0VWP4NgkwR/view?usp=sharing"
              target="_blank"
            >
              Currículo
            </Link>
        ...
        <IconGroup>
          <IconButton
            href="https://github.com/Rodrigo-Paim"
            target="_blank"
          ...
          {/* <IconButton
            href="https://www.linkedin.com/in/rodrigo-p-a6132b164/"
            target="_blank"
            rel="noopener noreferrer"
          >
